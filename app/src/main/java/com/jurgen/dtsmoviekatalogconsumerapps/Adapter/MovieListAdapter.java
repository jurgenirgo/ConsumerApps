package com.jurgen.dtsmoviekatalogconsumerapps.Adapter;
...
import com.jurgen.dtsmoviekatalogconsumerapps.Details;
...
public class MovieListAdapter extends RecyclerView.Adapter<MovieListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final MovieModel model = arrayList.get(position);

        Glide.with(context).load(IMAGE_URL + model.getPosterPath()).into(holder.imageView);
